...
public class ArbolNomina {
    ...
    private Empleado insertar(Empleado nodo, int cedula, String nombre, String departamento, double salario) {
        if (nodo == null)
            return new Empleado(cedula, nombre, departamento, salario);
    ...
    public double calcularNominaTotal() {
        return calcularNominaTotal(raiz);
    }
    ...
    public int contarSalarioMayorA(double umbral) {
        return contarSalarioMayorA(raiz, umbral);
    }
}